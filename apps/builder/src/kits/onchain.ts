...
// `forge build`s + deploys the (known-good) template to Base, and the bridge wires
...
— the builder compiles + deploys it to Base and wires sdk.onchain to its address.
