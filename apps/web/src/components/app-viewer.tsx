...
// ▸ Play in the feed): the app fills the viewport edge-to-edge below a slim top
// bar. ✕ returns to the Discover feed. AppChrome leaves /app/* full-
...
export function AppViewer({ app }: { app: ViewerApp }) {
  ...
  return <AppStage app={app} onClose={() => router.push("/")} />;
}
